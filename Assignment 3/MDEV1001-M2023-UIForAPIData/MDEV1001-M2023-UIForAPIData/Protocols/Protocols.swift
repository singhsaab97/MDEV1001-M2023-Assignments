...
extension ViewLoadable where Self: UITableViewCell {
    ...
    static func dequeCell(from tableView: UITableView, at indexPath: IndexPath) -> Self {
...
extension ViewLoadable where Self: UICollectionViewCell {
    ...
    static func dequeCell(from collectionView: UICollectionView, at indexPath: IndexPath) -> Self {
...
extension Toastable {
    ...
    func showToast(with message: String?) {
        ...
        view.widthAnchor.constraint(lessThanOrEqualTo: window.widthAnchor, multiplier: 0.8).isActive = true
